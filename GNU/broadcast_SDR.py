...
class broadcast_SDR(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "SDR_transmit")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("SDR_transmit")
        ...
        self.settings = Qt.QSettings("GNU Radio", "broadcast_SDR")
        ...
        # Blocks
        ##################################################
        self._volume_range = Range(0, 10, .01, 1.2, 200)
        ...
        self.uhd_usrp_sink_0.set_center_freq(107900000, 0)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 600000, .5, 0, 0)
...
def main(top_block_cls=broadcast_SDR, options=None):
