...
class FM3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FM_transmit3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM_transmit3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "FM3")
        ...
        self.uhd_usrp_sink_0.set_samp_rate(192000)
