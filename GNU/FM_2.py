...
class FM_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "FM_2")
        ...
        self.uhd_usrp_sink_0.set_samp_rate(64000)
...
def main(top_block_cls=FM_2, options=None):
