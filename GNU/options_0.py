...
class options_0(gr.top_block):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_char*1, '/home/jshall/Projects/21-29-Starobike/GNU/received3.txt', False)
        ...
        self.connect((self.digital_constellation_decoder_cb_1, 0), (self.fec_tagged_decoder_0, 0))
        ...
        self.connect((self.fec_tagged_decoder_0, 0), (self.blocks_repack_bits_bb_0, 0))
