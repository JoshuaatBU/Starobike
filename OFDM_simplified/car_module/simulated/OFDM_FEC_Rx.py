...
class OFDM_FEC_Rx(gr.top_block):

    def __init__(self, pld_dec=fec.dummy_decoder.make(8000)):
        gr.top_block.__init__(self, "OFDM FEC Rx")
        ...
        self.freq_xlating_fir_filter_xxx_0 = filter.freq_xlating_fir_filter_ccc(1, firdes.low_pass(1, samp_rate, filter_cutoff, filter_transition), cent_freq, samp_rate)
        ...
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_char*1, '127.0.0.1', 7007, 1472, True)
        self.blocks_throttle_1_0 = blocks.throttle(gr.sizeof_char*1, samp_rate/8,True)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/jshall/Projects/21-29-Starobike/OFDM_simplified/car_module/recieved.bin', False)
        ...
        self.connect((self.blocks_throttle_1_0, 0), (self.blocks_file_sink_0, 0))
        self.connect((self.blocks_throttle_1_0, 0), (self.blocks_udp_sink_0, 0))
        self.connect((self.digital_constellation_decoder_cb_0, 0), (self.digital_packet_headerparser_b_0, 0))
        self.connect((self.digital_constellation_decoder_cb_1, 0), (self.blocks_repack_bits_bb_0, 0))
        self.connect((self.digital_crc32_bb_0, 0), (self.blocks_throttle_1_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.blocks_throttle_1_0.set_sample_rate(self.samp_rate/8)
    ...
    def set_cent_freq(self, cent_freq):
        ...
        self.freq_xlating_fir_filter_xxx_0.set_center_freq(self.cent_freq)
...
def main(top_block_cls=OFDM_FEC_Rx, options=None):
    if options is None:
