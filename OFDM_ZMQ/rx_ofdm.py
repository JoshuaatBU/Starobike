...
class rx_ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.filter_transition = filter_transition = 60000
        self.filter_cutoff = filter_cutoff = 200000
        self.cent_freq = cent_freq = 123456
        ...
        self.uhd_usrp_source_0.set_gain(61, 0)
        ...
        self.blocks_udp_sink_0 = blocks.udp_sink(gr.sizeof_char*1, '127.0.0.1', 7007, 1472, False)
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_char*1, '/home/jshall/Projects/21-29-Starobike/OFDM_ZMQ/received.bin', False)
